...
const LayoutGrid = () => <div className="h-4 w-4">📊</div>;
const Keyboard = () => <div className="h-4 w-4">⌨️</div>;
const WrapText = () => <div className="h-4 w-4">📝</div>;
const Calculator = () => <div className="h-4 w-4">🧮</div>;
const FunctionSquare = () => <div className="h-4 w-4">𝑓(𝑥)</div>;
const Grid3X3 = () => <div className="h-4 w-4">▦</div>;
const Ruler = () => <div className="h-4 w-4">📏</div>;
const Code = () => <div className="h-4 w-4">{"</>"}</div>;