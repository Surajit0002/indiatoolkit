      ...
      <div className="max-w-4xl mx-auto bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden">
        <div className="p-8 grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            >
              {selectedFile ? (
                ...
                <>
                  ...
                  <p className="text-sm text-gray-400 font-bold uppercase">Upload Excel File</p>
                </>
              )}
              <input 
                type="file" 
          ...
          <div className="bg-gray-50 rounded-2xl flex flex-col items-center justify-center p-8 border border-gray-100 text-center">
            {converted ? (
              <div className="space-y-6">
                <div className="h-20 w-20 bg-blue-100 text-blue-600 rounded-3xl flex items-center justify-center mx-auto">
                  <FileText className="h-10 w-10" />
                </div>
                <div>
                  <h3 className="font-black text-gray-900 uppercase tracking-tight">Conversion Complete</h3>
                  <p className="text-sm text-gray-500 mt-1">Your CSV file is ready for download.</p>
                </div>
                <button
              ...
              <div className="opacity-30 space-y-4">
                ...
                <p className="text-sm font-bold uppercase text-gray-400">CSV Preview</p>
              </div>
            )}
          </div>
        </div>
