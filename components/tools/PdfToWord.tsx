...
import { FileText, Upload, ArrowRight, Loader2, Info } from "lucide-react";
      ...
      <div className="max-w-2xl mx-auto bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden">
        <div className="p-8 text-center space-y-8">
          <div className="flex flex-col items-center gap-4">
            ...
            <p className="text-gray-500 max-w-sm">Easily convert your PDF files into editable DOCX documents.</p>
          </div>
          ...
          {file && !isComplete && (
            ...
            >
              ...
              {isConverting ? "Converting PDF..." : "Convert to Word"}
            </button>
          )}
          ...
          {isComplete && (
            <div className="bg-emerald-50 border border-emerald-100 p-6 rounded-2xl space-y-4">
              ...
              <div className="text-xs text-emerald-600 leading-relaxed max-w-xs mx-auto">
                In a production environment, your converted file would be ready for download here.
              </div>
          ...
          <div className="bg-gray-50 p-4 rounded-xl flex gap-3 text-left">
            ...
            <p className="text-[10px] text-gray-400 uppercase font-bold tracking-widest leading-normal">
              Note: This is a demonstration UI. In a real application, this would process the file using a secure server-side PDF conversion library.
            </p>
          </div>
        </div>
      </div>
