  ...
  const convertImage = () => {
    ...
    reader.onload = (event) => {
      ...
      img.onload = () => {
        ...
        const convertedDataUrl = canvas.toDataURL("image/webp", 0.8);
        ...
        <div className="p-8 grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="space-y-6">
            ...
            <button
              ...
              className="w-full h-14 bg-teal-600 text-white rounded-xl hover:bg-teal-700 disabled:bg-gray-200 transition-all font-bold flex items-center justify-center gap-2"
            >
